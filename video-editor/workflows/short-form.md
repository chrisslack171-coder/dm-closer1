...
Two presets — decide when you reach Graphics. If it's not obvious from the footage, ask one line: *"talking-head explainer or TikTok/raw?"* Both ran the same rough cut; they only differ here.
